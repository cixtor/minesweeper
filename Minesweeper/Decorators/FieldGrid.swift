...
class FieldGrid: UICollectionView {
    ...
    override init(frame: CGRect, collectionViewLayout layout: UICollectionViewLayout) {
        ...
        if let layout = layout as? FieldGridLayout {
...
extension FieldGrid: UIGestureRecognizerDelegate {
...
extension FieldGrid: FieldGridLayoutDelegate {
...
extension FieldGrid: UICollectionViewDelegateFlowLayout {
