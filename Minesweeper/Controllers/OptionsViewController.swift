...
class OptionsViewController: UIViewController {
    enum Constant {
        static let dimensionRange: [Int] = Array(Constants.minimumFieldDimension...Constants.maximumFieldDimension)
        static let mineRange: [Int] = Array(Constants.minimumMines...Constants.maximumMines)
    ...
    private func updateDifficultyLabels() {
        ...
        if self.gameOptions.rowCount == Constant.easyDimension, self.gameOptions.minesCount == Constant.easyMines {
            ...
            newDifficultyButton = self.easyButton /* easy */
            ...
            newDifficultyButton = self.intermediateButton /* intermediate */
            ...
            newDifficultyButton = self.expertButton /* expert */
        }
